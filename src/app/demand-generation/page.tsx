  ...
  return (
    <main>
      ...
      <section style={{ background: "#cb772d", padding: "80px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 17, color: "rgba(255,255,255,0.85)", marginBottom: 36, maxWidth: 480, margin: "0 auto 36px" }}>Book a session and we&apos;ll build your demand generation plan — channels, targeting, and 90-day pipeline forecast.</p>
