  ...
  return (
    <main>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, background: "rgba(10,20,40,0.85)" }} />
      ...
      <section style={{ background: "#cb772d", padding: "80px 24px", textAlign: "center" }}>
        <h2 style={{ fontFamily: "'Burford Rustic Black', Helvetica, Arial, Lucida, sans-serif", fontWeight: 700, fontSize: "clamp(30px, 4vw, 52px)", textTransform: "uppercase", letterSpacing: "0.02em", color: "#FFFFFF", marginBottom: 16 }}>Your Transformation Story Starts Here</h2>
        <p style={{ fontSize: 17, color: "rgba(255,255,255,0.88)", marginBottom: 36, maxWidth: 500, margin: "0 auto 36px" }}>Every client engagement begins with understanding your current state and designing the system that will power your next stage of growth.</p>
