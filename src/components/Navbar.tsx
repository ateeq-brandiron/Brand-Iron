...
const services = [
  ...
  { label: "AI Execution & Automation", href: "/ai-execution" },
  { label: "GTM & Sales Systems", href: "/gtm-sales-systems" },
  { label: "Branding & High-Converting Decks", href: "/branding-decks" },
  { label: "Data & Revenue Visibility", href: "/data-revenue-visibility" },
  { label: "Demand Generation & Pipeline", href: "/demand-generation" },
];

const navLinks = [
  { label: "Process", href: "/process" },
  { label: "Outcomes", href: "/outcomes" },
  { label: "Case Studies", href: "/transformation-stories" },
            ...
            >
              ...
              {servicesOpen && (
                <div style={{
                  ...
                  borderRadius: 8, padding: "8px 0", minWidth: 280,
        ...
        {open && (
          <div style={{ paddingBottom: 24, borderTop: "1px solid rgba(255,255,255,0.1)", background: "rgba(13,26,46,0.98)" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 4, paddingTop: 16 }}>
              ...
              {services.map((s) => (
                <Link key={s.href} href={s.href} onClick={() => setOpen(false)} style={{ padding: "8px 0", fontFamily: "'Montserrat', sans-serif", fontWeight: 500, fontSize: 14, color: "rgba(255,255,255,0.8)", textDecoration: "none", paddingLeft: 12 }}>{s.label}</Link>
              ))}
              ...
              <div style={{ paddingTop: 12 }}>
                <Link href="/contact" className="btn-primary" onClick={() => setOpen(false)}>Book Strategy Session</Link>
              </div>
            </div>
          </div>
        )}
